...
globalkeys = gears.table.join(
    ...
    -- Firefox
    awful.key({ modkey, "Mod1" }, "b", function() awful.spawn("firefox -no-remote -ProfileManager") end,
        { description = "open firefox", group = "applications" }),
    -- dmenu_script
    awful.key({ modkey, }, "p", function() awful.spawn("/home/ashish/.scripts/dmenu") end,
        { description = "open dmenu", group = "launcher" }),
    -- dmenu for flatpak apps
    ...
    awful.key({}, "XF86AudioPlay", function()
        awful.util.spawn("/home/ashish/.scripts/playpause")
    end),
    ...
    awful.key({ modkey }, "`", function()
        awful.util.spawn("urxvt -e ncmpcpp")
    end),

    -- touchpad toggle
    awful.key({}, "XF86XKTouchpadToggle", function()
        awful.util.spawn("/home/ashish/dis.sh")
    end),

    -- screenshots
    awful.key({}, "Print", function()
        awful.util.spawn("flameshot full -p /home/ashish/Pictures/screenshots")
    end),
    awful.key({ "Control" }, "Print", function()
        awful.util.spawn("flameshot gui -p /home/ashish/Pictures/screenshots/gui")
    end),

    -- brightness control
    awful.key({}, "XF86MonBrightnessUp", function()
        awful.util.spawn("/home/ashish/scripts/brup.sh")
    end),
    awful.key({}, "XF86MonBrightnessDown", function()
        awful.util.spawn("/home/ashish/scripts/brdown.sh")
    end),
    awful.key({ modkey }, "c", function()
        awful.util.spawn("xclip -sel s /dev/null")
    end),

    -- destroy notifications
    awful.key({ modkey, "Shift" }, "x", function() naughty.destroy_all_notifications() end,
        { description = "destroy visible notifications", group = "misc" })
-- Menubar
